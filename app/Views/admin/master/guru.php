    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 mb-5">
        <div class="flex flex-col lg:flex-row lg:items-center gap-3">
            ...
            <div class="flex flex-wrap items-center gap-2 lg:justify-end">
                ...
                <a href="<?= site_url('admin/master/guru/export') ?>" title="Keluarkan semua data guru ke file Excel" class="inline-flex items-center gap-1.5 rounded-lg border border-slate-300 bg-white text-slate-600 hover:bg-slate-50 text-sm font-semibold px-3.5 py-2.5 transition">
