                    ...
                    <?php else: foreach ($rows as $r): $beda = (int) $r['jp'] !== (int) $r['jp_default']; ?>
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-6 py-3 text-right whitespace-nowrap">
                                ...
                                <a href="<?= site_url('admin/master/pengampu/delete/' . $r['id']) ?>" onclick="return confirm('Hapus penugasan ini?')" class="ml-3 text-red-500 hover:text-red-700 font-medium">Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; endif; ?>
                </tbody>
