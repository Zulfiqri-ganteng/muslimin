                    ...
                    <?php else: foreach ($rows as $r): ?>
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-4 py-3 text-right whitespace-nowrap">
                                <a href="<?= site_url('admin/lab-gambar/perbaikan/' . (int) $r['id']) ?>" title="Foto" class="inline-flex h-8 w-8 items-center justify-center rounded-lg text-slate-500 hover:bg-slate-100 transition align-middle">
