...
<div style="border-bottom: 3px double #1a3a6b; padding-bottom: 6px; margin-bottom: 12px;">
    <table style="width:100%; border-collapse:collapse;">
        <tr>
            <td style="width:104px; text-align:center; vertical-align:top; border:0; padding:0; background:none;">
                <?php if ($logo): ?><img src="<?= $logo ?>" style="height:86px; width:auto; max-width:100px; margin-top:-8px;"><?php endif; ?>
            </td>
