...
<style>
    * { font-family: "DejaVu Sans", sans-serif; }
    ...
    .gh { background: #eef2ff; font-weight: bold; }
    .total td { font-weight: bold; background: #f1f5f9; }
    .right { text-align: right; }
    .badge { font-size: 9px; padding: 1px 5px; border-radius: 8px; }
    .foot { margin-top: 6px; font-size: 9px; color: #94a3b8; text-align: right; }
</style>
</head>
<body>
    <div class="head">
    ...
    ?>
        <table>
            ...
            <tr><th style="width:45%">Mata Pelajaran</th><th style="width:35%">Kelas</th><th colspan="2" class="right" style="text-align:right">JP</th></tr>
            ...
            <?php endforeach; ?>
            <tr class="total"><td colspan="2">TOTAL</td><td colspan="2" class="right"><?= $total ?> JP</td></tr>
        </table>
