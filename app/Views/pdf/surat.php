...
<body>
    ...
    <table class="data">
        <tr>
            ...
            <td class="sep">:</td>
            <td><b><?= esc($row['nama_lengkap']) ?></b></td>
        </tr>
        <tr>
            <td class="lbl">Pendidikan Terakhir</td>
            <td class="sep">:</td>
            <td><?= esc($row['pendidikan_terakhir'] ?: '-') ?></td>
        </tr>
        <tr>
            <td class="lbl">Guru Mapel</td>
            <td class="sep">:</td>
            <td><?= esc($row['guru_mapel'] ?: '-') ?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="lbl">Kesediaan Mengajar</td>
            <td class="sep">:</td>
            <td><b><?= $bersedia ? 'BERSEDIA' : 'TIDAK BERSEDIA' ?></b></td>
        </tr>
    </table>
            ...
            <tbody>
                <?php if (! empty($row['mapel_diampu'])): foreach ($row['mapel_diampu'] as $i => $m): ?>
                        <tr>
                            ...
                            <td><?= esc($m['mapel']) ?></td>
                            <td style="text-align:center"><?= esc($m['kelas']) ?></td>
                        </tr>
                    <?php endforeach;
                else: ?>
                    <tr>
                        <td colspan="3" style="text-align:center" class="muted">—</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
